        ...
        <div className="cards">
            <div className="card">
                ...
                <div className="card-content">
                    <img src="card1-removebg-preview.png" alt="" className="card-img"/>
                    ...
                    <button onclick="openAptosDocs()" className="card-btn">Start Building</button>
                </div>

            </div>
            <div className="card">
                <div className="card-content">
                    <img src="card2-removebg-preview.png" alt="" className="card-img"/>
                    ...
                    <button onclick="openInteractiveMoveCourse()"  className="card-btn">Learn</button>
                </div>
            </div>
            <div className="card">
                <div className="card-content">
                    <img src="card3-removebg-preview.png" alt="" className="card-img"/>
                    ...
                    <button className="special-btns card-btn">Explore</button>
                </div>
            </div>
            <div className="card">
                <div className="card-content">
                    <img src="card4-removebg-preview.png" alt="" className="card-img"/>
                    ...
                    <p className="card-writeUp-desc">Based on a curated data, hire the perfect fit for your project using
                        our extensive jobs board.</p>
                    <button className="btn card-btn">Apply</button>
                </div>
            </div>
            <div className="card">
                <div className="card-content">
                    <img src="graduation-hat.png" alt="" className="card-img"/>
                    ...
                    <button onclick="mailTo()" className="btn card-btn">Connect</button>
                </div>
            </div>
        </div>
    </section>

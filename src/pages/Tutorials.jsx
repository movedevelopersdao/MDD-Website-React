          ...
          <div className="section-description">
            ...
            <div className="link-box">
              <a href="https://discord.com/invite/AVr5u59tXs">
                <h1 className="sec-desc-link-text">Submit a tutorial</h1>
              </a>
            </div>
          </div>

          <div className="tuts-display">
            <a href="https://twitter.com/MoveBuilders/status/1671584023276322816?s=20">
              <div className="tut-display-card first-tut-card">
                <h1 className="tut-card-head-text">
                  The Daily Move by Move Developers DAO
                </h1>
            ...
            <a href="https://twitter.com/MoveBuilders/status/1674749690590674946?s=20">
              <div className="tut-display-card first-tut-card">
                <h1 className="tut-card-head-text">
                Code by Code example on Token V2
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://twitter.com/mokshyaprotocol/status/1672254852565483522?s=46&t=kBTupNczloP4cV_gyqVNnw">
              <div className="tut-display-card first-tut-card">
                <h1 className="tut-card-head-text">
                  Token v2 by Mokshya protocol
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://twitter.com/Aptos_Network/status/1661489022626332675">
              <div className="tut-display-card first-tut-card">
                <h1 className="tut-card-head-text">
                Aptos Move object official thread
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://metapixelblog.medium.com/why-the-new-aptos-token-object-is-a-game-changer-58b0977313a">
              <div className="tut-display-card first-tut-card">
                <h1 className="tut-card-head-text">
                Why Aptos object is a game changer
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
                ...
                <h1 className="tut-card-sub-text">Basics of Aptos objects
                </h1>
              </div>
            </a>
            <a href="https://overmind-xyz.medium.com/demystifying-aptos-object-and-tokenv2-part-1-c8e904ff3175">
              <div className="tut-display-card first-tut-card">
                <h1 className="tut-card-head-text">
                Article on Aptos object - P2
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://medium.com/mokshyaprotocol/write-your-first-smart-contract-on-aptos-a-step-by-step-guide-e16a6f5c2be6">
              <div className="tut-display-card first-tut-card">
                ...
                <h1 className="tut-card-sub-text">
                  A step by step guide to write your first smart contract in
                  Move
                </h1>
              </div>
            </a>

            <a href="https://medium.com/code-community-command">
              <div className="tut-display-card">
                <h1 className="tut-card-head-text">
                  Wayne Culbreth Aptos Tutorial{" "}
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://github.com/zellic/move-prover-examples">
              <div className="tut-display-card">
                <h1 className="tut-card-head-text">
                  Zellic Move Prover Tutorial
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://medium.com/aptoslabs/block-stm-how-we-execute-over-160k-transactions-per-second-on-the-aptos-blockchain-3b003657e4bas">
              <div
            ...
            <a href="https://jacobadevore.medium.com/revolutionize-your-aptos-smart-contract-1a855c5cae7a">
              <div className="tut-display-card">
                <h1 className="tut-card-head-text">
            ...
            <a href="https://github.com/aptos-labs/aptos-core/tree/main/aptos-move/move-examples">
              <div className="tut-display-card">
            ...
            <a href="https://aptos.dev/tutorials/">
              <div className="tut-display-card">
            ...
            <a href="https://github.com/MystenLabs/awesome-move">
              <div className="tut-display-card">
                ...
                <h1 className="tut-card-sub-text">
                  An all in one guide to all Move Language resources,
                  information, communities, podcasts, tools and more.
                </h1>
              </div>
            </a>
            <a href="https://github.com/econia-labs/teach-yourself-move">
              <div className="tut-display-card">
            ...
            <a href="https://www.pentagon.xyz/">
              <div className="tut-display-card">
                ...
                <h1 className="tut-card-sub-text">
                  Open sources examples and libraries maintained by Pentagon
                  team
                </h1>
              </div>
            </a>
            <a href="https://aptos.dev/reference/glossary">
              <div className="tut-display-card">
            ...
            <a href="http://www.aptoseden.com/">
              <div className="tut-display-card">
                <h1 className="tut-card-head-text">
                  Video Tutorials By Aptos Eden
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://osec.io/blog/2022-09-06-move-introduction/">
              <div className="tut-display-card">
                <h1 className="tut-card-head-text">
                  Move Introduction By Otter Sec
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
            ...
            <a href="https://www.movebit.xyz/blog/post/move-prover-tutorial-part-1.html">
              <div className="tut-display-card">
                <h1 className="tut-card-head-text">
                  MoveBit Move Prover Tutorial
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
                ...
                <h1 className="tut-card-sub-text">
                  Move Prover tutorial by MoveBit
                </h1>
              </div>
            </a>
            ...
            <a href="https://www.zellic.io/blog/top-10-aptos-move-bugs">
              <div className="tut-display-card last-tut-card">
                <h1 className="tut-card-head-text">
                  Aptos Move Language hacks
                </h1>
                <div className="tut-card-details">
                  <div className="tut-card-detail">
                    <div className="tut-card-detail-img-box">
